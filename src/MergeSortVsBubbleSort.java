...
public class MergeSortVsBubbleSort
{

    public MergeSortVsBubbleSort()
    {
    }
        ...
        throws Exception
    {
        ...
        do
        {
           ...
           // System.out.print("\nMergeSort Numbers: \n" + Arrays.toString(sortedArray));
            System.out.println((new StringBuilder("\nThe sorted array is in correct order: ")).append(isSorted(sortedArray)).toString());
            startTime = System.currentTimeMillis();
           ...
           // System.out.print("\n");
            ...
            System.out.println((new StringBuilder("\nMergeSort is ")).append(String.valueOf(bubbleTime/mergeTime)).append(" times faster than BubblesortSort."));
           
            System.out.println("\nPlease enter the size of input array, or 0(to exit):");
           
            arrayLength = scanner.nextInt();
        } while(!(arrayLength==0));
        System.out.printf("Thanks for using this program. Goodbye!\n\n");
        scanner.close();
